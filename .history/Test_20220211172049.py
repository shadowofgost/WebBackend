...
def test_model_name():
    print(type(ModelUserExtension.__name__),ModelUserExtension.__name__)
    print(ModelCurriculaSelectOutSingleTableSchemaBase.__name__,type(ModelCurriculaSelectOutSingleTableSchemaBase.__name__))
    print(ModelCurriculaSelectOutSingleTableSchema.__name__,type(ModelCurriculaSelectOutSingleTableSchema.__name__))
    print(ModelCurriculaSelectInSingleTableSchema.__name__,type(ModelCurriculaSelectInSingleTableSchema.__name__))
