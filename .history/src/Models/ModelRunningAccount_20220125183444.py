...
def ModelRunningAccount_multiple_require_select(
    model,
    schema,
    session: Session,
    physical: bool = False,
    ...
    """
    ModelRunningAccount_multiple_require_select [特殊选择的表]
...
def ModelRunningAccount_condition_select(
    model,
    session: Session,
    condition: str = "",
    physical: bool = False,
    ...
    """
    ModelRunningAccount_condition_select [根据传入的条件进行查询]
...
def ModelRunningAccount_name_select(
    model,
    session: Session,
    name: str,
    physical: bool = False,
    ...
    """
    ModelRunningAccount_name_select [根据传入的条件进行查询]
