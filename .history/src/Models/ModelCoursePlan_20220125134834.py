...
ModelCoursePlan_exclude_update_columns = ["TimeUpdate", "IMark", "IdManager"]
ModelCoursePlan_exclude_update_columns.extend(exclude)
ModelCoursePlan_exclude_insert_columns = ModelCoursePlan_exclude_update_columns[:]
ModelCoursePlan_exclude_insert_columns.extend(["TimeCreate"])
