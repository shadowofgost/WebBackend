...
# @Software         : Vscode
# @FilePath         : /WebBackend/src/Models/ORM.py
# @Copyright Notice : Copyright (c) ${now_year} Albert Wang 王子睿, All Rights Reserved.
# @Copyright (c) 2022 Albert Wang 王子睿, All Rights Reserved.
# @Description      :
# @LastTime         : 2022-01-27 12:13:49
...
from .ModelCurricula import ModelCurricula,ModelCurriculaUpdateSingleGetSchema,ModelCurriculaUpdateMultipleGetSchema,ModelCurriculaUpdateSingleTableSchema,ModelCurriculaUpdateMultipleTableSchema,ModelCurriculaInsertSingleGetSchema,ModelCurriculaInsertMultipleGetSchema,ModelCurriculaInsertSingleTableSchema,ModelCurriculaInsertMultipleTableSchema,ModelCurriculaSelectOutSingleTableSchema,ModelCurriculaSelectInSingleTableSchema,ModelCurricula_sub_stmt
from .ModelDepartment import ModelDepartment,ModelDepartmentUpdateSingleGetSchema,ModelDepartmentUpdateMultipleGetSchema,ModelDepartmentUpdateSingleTableSchema,ModelDepartmentUpdateMultipleTableSchema,ModelDepartmentInsertSingleGetSchema,ModelDepartmentInsertMultipleGetSchema,ModelDepartmentInsertSingleTableSchema,ModelDepartmentInsertMultipleTableSchema,ModelDepartmentSelectOutSingleTableSchema,ModelDepartmentSelectInSingleTableSchema,ModelDepartment_sub_stmt
from.ModelEquipment import ModelEquipment,ModelEquipmentUpdateSingleGetSchema,ModelEquipmentUpdateMultipleGetSchema,ModelEquipmentUpdateSingleTableSchema,ModelEquipmentUpdateMultipleTableSchema,ModelEquipmentInsertSingleGetSchema,ModelEquipmentInsertMultipleGetSchema,ModelEquipmentInsertSingleTableSchema,ModelEquipmentInsertMultipleTableSchema,ModelEquipmentSelectOutSingleTableSchema,ModelEquipmentSelectInSingleTableSchema,ModelEquipment_sub_stmt
from .ModelLocation import ModelLocation,ModelLocationUpdateSingleGetSchema,ModelLocationUpdateMultipleGetSchema,ModelLocationUpdateSingleTableSchema,ModelLocationUpdateMultipleTableSchema,ModelLocationInsertSingleGetSchema,ModelLocationInsertMultipleGetSchema,ModelLocationInsertSingleTableSchema,ModelLocationInsertMultipleTableSchema,ModelLocationSelectOutSingleTableSchema,ModelLocationSelectInSingleTableSchema,ModelLocation_sub_stmt,ModelLocationExtension,ModelLocationExtensionUpdateSingleGetSchema,ModelLocationExtensionUpdateMultipleGetSchema,ModelLocationExtensionUpdateSingleTableSchema,ModelLocationExtensionUpdateMultipleTableSchema,ModelLocationExtensionInsertSingleGetSchema,ModelLocationExtensionInsertMultipleGetSchema,ModelLocationExtensionInsertSingleTableSchema,ModelLocationExtensionInsertMultipleTableSchema,ModelLocationExtensionSelectOutSingleTableSchema,ModelLocationExtensionSelectInSingleTableSchema,ModelLocationExtension_sub_stmt
from .ModelMmx import ModelMmx,ModelMmxUpdateSingleGetSchema,ModelMmxUpdateMultipleGetSchema,ModelMmxUpdateSingleTableSchema,ModelMmxUpdateMultipleTableSchema,ModelMmxInsertSingleGetSchema,ModelMmxInsertMultipleGetSchema,ModelMmxInsertSingleTableSchema,ModelMmxInsertMultipleTableSchema,ModelMmxSelectOutSingleTableSchema,ModelMmxSelectInSingleTableSchema,ModelMmx_sub_stmt
