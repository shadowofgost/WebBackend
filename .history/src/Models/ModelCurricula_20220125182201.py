...
def ModelCurricula_multiple_require_select(
    model,
    schema,
    session: Session,
    physical: bool = False,
    ...
    """
    ModelCurricula_multiple_require_select [特殊选择的表]
...
def ModelCurricula_condition_select(
    model,
    session: Session,
    condition: str = "",
    physical: bool = False,
    ...
    """
    ModelCurricula_condition_select [根据传入的条件进行查询]
...
def ModelCurricula_name_select(
    model,
    session: Session,
    name: str,
    physical: bool = False,
    ...
    """
    ModelCurricula_name_select [根据传入的条件进行查询]
