...
def ModelMmx_multiple_require_select(
    model,
    schema,
    session: Session,
    physical: bool = False,
    ...
    """
    ModelMmx_multiple_require_select [特殊选择的表]
...
def ModelMmx_condition_select(
    ...
    """
    ModelMmx_condition_select [根据传入的条件进行查询]
...
def ModelMmx_name_select(
    ...
    """
    ModelMmx_name_select [根据传入的条件进行查询]
...
def ModelMmxData_multiple_require_select(
    model,
    schema,
    session: Session,
    physical: bool = False,
    ...
    """
    ModelMmxData_multiple_require_select [特殊选择的表]
...
def ModelMmxData_condition_select(
    model,
    session: Session,
    condition: str = "",
    physical: bool = False,
    ...
    """
    ModelMmxData_condition_select [根据传入的条件进行查询]
...
def ModelMmxData_name_select(
    ...
    """
    ModelMmxData_name_select [根据传入的条件进行查询]
