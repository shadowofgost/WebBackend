...
ModelCoursePlanUpdateSingleGetSchema=sqlalchemy_to_pydantic(ModelCoursePlan,update_exclude)
class ModelCoursePlanUpdateMultipleGetSchema(ModelCoursePlanUpdateSingleGetSchema):
    ...
    n:int
class ModelCoursePlanUpdateTableSchema(ModelCoursePlanUpdateSingleGetSchema):
    TimeUpdate:int=
