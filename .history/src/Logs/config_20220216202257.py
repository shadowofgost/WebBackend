...
def init_logging():
    ...
    app_error = join(dirname(__file__), "app_error.log")
    app_stdout = join(dirname(__file__), "app_stdout.log")
    logger.add(
        app_info,
        enqueue=True,
        rotation="12:00",
