...
@router.get("/", response_model=Page[ModelDepartmentSelectOutSingleTableSchema])
async def api_model_department_get(
    schema: CurriculaGet,
    Params=Depends(),
    session: Session = Depends(get_db),
    user: ModelDepartmentSelectOutSingleTableSchema = Depends(get_current_user),
):
