...
from time import time,localtime,mktime,struct_time
...
print(mktime(struct_time(tm_year=2000, tm_mon=1, tm_mday=1, tm_hour=0, tm_min=0, tm_sec=0, tm_wday=5, tm_yday=15, tm_isdst=0)))
