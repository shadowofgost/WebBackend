...
exclude = ["back_up1", "back_up2", "back_up3", "back_up4", "back_up5", "back_up6","IMark"]
nullable = ["Rem"]
...
def sqlalchemy_to_pydantic(
    db_model: Type, config: Type = OrmConfig, exclude: Container[str] = [],nullable:Container[str]=[]
) -> Type[BaseModel]:
