...
class ORM:
    ...
    def total_select(self, physical:bool=False, offset_data:int=-1, limit_data:int=-1):
        if self.abstract_model == True:
    ...
    def special_choice_select(
        self, schema, physical:bool=False, offset_data:int=-1, limit_data:int=-1
    ):
        if self.abstract_model == True:
