...
class ModelRunningAccount(ModelPublic):
    ...
    Type_field = Column(
        ...
        name="Type",
        comment="记录的类型",
        doc="这是记录的类型，其值定义如下：参见T_CyTypeRA表，例如：交费、存款：0x101，赠费：0x102，退费、取款：0x103，扣费、罚款：0x104，纠错、取消某次缴费等：0x106，上机：0x201，考勤：0x1001",
    )
    ...
    Param1 = Column(
        ...
        index=True,
        comment="考勤机编号",
        doc="这是考勤机编号，例如：收费管理员的ID：Type=0x101，上机机位编号：Type=0x201，门禁考勤机编号：Type=0x1001",
    )
    Param2 = Column(
        BigInteger,
        index=True,
        comment="安排编号",
        doc="这是安排编号，例如：取消交易记录的ID：Type=0x106，讲座、课程的编号：Type=0x201、0x1001",
    )
