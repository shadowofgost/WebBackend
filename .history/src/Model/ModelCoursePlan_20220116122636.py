...
class ModelCoursePlan(ModelPublic):
    ...
    ListPlaces = Column(Unicode(1024),title="地点列表",doc="课程使用的地点列表")
    MapUser2Equ = Column(Unicode(1024),title="对应列表",doc="学生和课程的对应表")
    AboutSpeaker = Column(Unicode(1024),title="主讲人信息",doc="主讲人信息")
