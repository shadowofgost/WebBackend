...
class ModelUserex(Base):
    __tablename__ = 't_cyuserex'

    ID = Column(Integer, primary_key=True)
    Photo = Column(LargeBinary, nullable=False,comment="头像")
...
PydanticUserex = sqlalchemy_to_pydantic(ModelUserex)
print(ModelUserex.__dict__)
