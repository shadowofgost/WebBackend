    ...
    for attr in mapper.attrs:
        if isinstance(attr, ColumnProperty):
            if attr.columns:
                ...
                ##ppfields[name] =(python_type, default)
                fields[name]=Field(description=description, max_length=max_length,title=title,default=default)
